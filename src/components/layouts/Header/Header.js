          ...
          >
            <div layout="vertical">
              <div className="header-top">
                <Title level={4}>
                  Cài đặt
                  <Text className="subtitle">Tùy chỉnh theo cách của bạn.</Text>
                </Title>
              </div>
              ...
              <div className="sidebar-color">
                ...
                <div className="sidebarnav-color mb-2">
                  <Title level={5}>Loại thanh điều hướng</Title>
                  <Text>
                    Chọn giữa 2 loại thanh điều hướng khác nhau. Trắng trong
                    suốt
                  </Text>
                ...
                <div className="fixed-nav mb-2">
                  <Title level={5}>Cố định tiêu đề</Title>
